  ...
  Future<void> _handleAuthorityLogin() async {
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        debugPrint(
          '[Authority Login] ✓ Success - Role: $role, Department: $department',
        );

        if (mounted) {
          // Route based on role: admins go to AdminDashboard, authorities go to AuthorityDashboard
          if (role == 'admin') {
      ...
      debugPrint('[Authority Login] ✗ Error: $e');
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        elevation: 0,
        title: const Text('Authority Login', style: TextStyle(fontFamily: 'Outfit', fontWeight: FontWeight.w600)),
        centerTitle: true,
        leading: IconButton(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: _primaryColor.withAlpha(60), width: 1),
              ),
              child: Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  ...
                  Text(
                    'Your authority account must be verified and approved by an administrator before you can access the dashboard. Once approved, you will receive an email notification with login instructions. Contact your department administrator if you have questions.',
                    style: Theme.of(context).textTheme.bodySmall?.copyWith(
